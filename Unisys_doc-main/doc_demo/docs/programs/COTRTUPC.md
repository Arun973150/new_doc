...
| `SELECT` | CARDDEMO.TRANSACTION_TYPE | None | 1475 |
| `UPDATE` | CARDDEMO.TRANSACTION_TYPE | None | 1544 |
| `INSERT` | CARDDEMO.TRANSACTION_TYPE | None | 1597 |
| `DELETE` | CARDDEMO.TRANSACTION_TYPE | None | 1627 |
